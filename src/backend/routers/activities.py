...
def get_activities(
    ...
    - difficulty: Filter activities by difficulty level (e.g., 'Beginner', 'Intermediate', 'Advanced', or 'all' for no difficulty specified)
    """
    ...
    if difficulty:
        if difficulty.lower() == "all":
            # "All" means activities without a difficulty level
